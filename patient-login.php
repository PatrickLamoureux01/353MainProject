                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-md-5 p-0 d-none d-lg-block">
                                ...
                                <p class="p-5">Please login with the information that was provided to you.</p>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="Model/validate.php" method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" name="dob" id="dob" placeholder="DOB (ddmmyyyy)">
                                        </div>
                                        <input type="hidden" name="sourcePage" value="patient" />
                                        ...
                                        if (isset($_GET["status"])) {
                                            ...
                                            switch ($_GET["status"]) {
                                                case "1001":
                                                    echo "<div align='middle'><font color='red'>Invalid medicare number and/or date of birth.</font></div>";
                                                    break;
                                            }
                                        }
                                        ?>
