...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row" style="text-align:center;">
                        ...
                        <div class="col-md-4" style="border-left:1px solid rgba(0,0,0,.1);height:250px">
                            ...
                            <button type="button" class="btn btn-outline-primary btn-block">Access Health Workers</button>
                        </div>
                        <div class="col-md-4" style="border-left:1px solid rgba(0,0,0,.1);height:250px">
                            ...
                            <button type="button" class="btn btn-outline-primary btn-block">Access Facilities</button>
                        </div>
                    </div>
                    <hr>
                    <div class="row" style="text-align:center;">
                        ...
                        <div class="col-md-4">
                            ...
                            <button type="button" class="btn btn-outline-primary btn-block">Access Regions</button>
                        </div>
                        <div class="col-md-4" style="border-left:1px solid rgba(0,0,0,.1);height:250px">
                            ...
                            <button type="button" class="btn btn-outline-primary btn-block">Access Group Zones</button>
                        </div>
                        <div class="col-md-4" style="border-left:1px solid rgba(0,0,0,.1);height:250px">
                            ...
                            <button type="button" class="btn btn-outline-primary btn-block">Access Health Recommendations</button>
                        </div>
                    </div>
    ...
    <script>
        function view_patients() {
            window.location.href = "view_patients_admin.php";
        }
    </script>
