...
<head>
    ...
    <title>Health Worker Dashboard - <?php echo $fname; ?></title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"><?php echo $fname; ?>'s Health Worker Dashboard</h1>
                    </div>

                    <div class="row" style="text-align:center;">
                        <!-- Content Row -->
                        <div class="col-md-4">
                            <i class="fas fa-user-check" style="font-size:52px;"></i>
                            <p></p>
                        ...
                        <div class="col-md-4" style="border-left:1px solid rgba(0,0,0,.1);height:250px">
                            ...
                            <br>
                            <br>
                            <p>Consult a list of active patients.</p>
                            <button type="button" class="btn btn-outline-info btn-block" onclick="view_patients()">View Patients</button>
                        </div>
                        <div class="col-md-4" style="border-left:1px solid rgba(0,0,0,.1);height:250px">
                            <i class="fas fa-user-plus" style="font-size:52px;"></i>
                            <p></p>
                            <p><strong>CREATE PATIENT</strong></p>
                            <br>
                            <br>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="healthcare-login.php">Logout</a>
                </div>
            </div>
        </div>
    </div>
