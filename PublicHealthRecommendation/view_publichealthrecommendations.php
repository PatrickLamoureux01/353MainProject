...
$healthrec = get_all_public_health_rec($link);
?>
...
<title>View All Public Health Recommendations</title>
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Public Health Recommendations Overview</h1>
                    </div>

                    <div class="col pr-4 pt-4 text-right">
                        <a id="editbutton" class="m-0 pt-4 font-weight-bold text-primary" href="create_publichealthrecommendation.php"><i class="fa fa-plus"></i> Create Public Health Recommendation</a>
                    </div>
                        ...
                        <div class="col-xl-12 mb-4">
                            ...
                            <div class="card shadow">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">All Public Health Recommendations</h6>
                                </div>
                                <div class="card-body">
          ...
          <td> There are no recommendations to display. </td> 
                                                    ...
                                                    foreach ($healthrec as $rec) {
                                                        ...
                                                        echo ('">');
                                                        echo ($rec['alertLevel']);
                                                        echo ('</td><td class="clickable" data-href="edit_publichealthrecommendation.php?fid=');
                                                        echo $rec['recommendationID'];
                                                        echo ('"><button type="button" class="btn btn-secondary">Edit</button>');
                                                        echo ('</td><td><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deletePublicHealthRecModal" data-id="');
                                                        echo $rec['recommendationID'];
                                                        echo ('" data-name="');
                                                        echo ($rec['recommendation']);
                                                        echo ('">Delete</button>');
   ...
   <?php include('../nav/logout.php'); ?>
    ...
    <script>
        $(document).ready(function() {
            $('#publicHealthRecTable').DataTable();
