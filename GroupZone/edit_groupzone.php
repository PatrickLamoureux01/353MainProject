...
<title>Edit Group Zone - <?php echo $groupzone['name']; ?></title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Group Zone</h1>
                    </div>

                    <form action="../Model/groupzone_processor.php?action=edit" method="post">
                        <div class="form-group">
                            <label for="id" class="my-1 mr-2">Group Zone ID </label>
                            <input type="text" class="form-control" id="id" name="id" value="<?php echo $groupzone['id']; ?>" readonly>
                        </div>
                        <div class="form-group">
