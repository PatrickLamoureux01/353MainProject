...
$groupzones = get_all_group_zones($link);
?>
...
<title>View All Group Zones</title>
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Group Zones Overview</h1>
                    </div>
                        ...
                        <div class="col-xl-12 mb-4">
                            ...
                            <div class="card shadow">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">All Group Zones</h6>
                                </div>
                                <div class="card-body">
          ...
          <td> There are no group zones to display. </td> 
                                                    ...
                                                    foreach ($groupzones as $groupzone) {
                                                        ...
                                                        echo ('">');
                                                        echo ($groupzone['name']);
                                                        echo ('</td><td class="clickable" data-href="edit_groupzone.php?fid=');
                                                        echo $groupzone['id'];
                                                        echo ('"><button type="button" class="btn btn-secondary">Edit</button>');
                                                        echo ('</td><td><button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteGroupZoneModal" data-id="');
                                                        echo $groupzone['id'];
                                                        echo ('" data-name="');
                                                        echo ($groupzone['name']);
                                                        echo ('">Delete</button>');
